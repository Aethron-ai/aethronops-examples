# Compliance Matrix — storage-baseline

> AethronOps compliance report for pattern **storage-baseline** (mini, tier basic).
...
|-----------|-----------------|-----------|
| **CAF** (Cloud Adoption Framework) | DATA-1, GOV-1, GOV-3, ID-1, ID-2, OPS-1, OPS-2, RG-1, RG-2, SEC-3, SEC-4 | [Microsoft CAF](https://learn.microsoft.com/azure/cloud-adoption-framework/) |
...
| **NIS2** (EU Directive 2022/2555) | ART-21-2b, ART-21-2f, ART-21-2h, ART-21-2i | [NIS2 Directive](https://eur-lex.europa.eu/eli/dir/2022/2555) |
