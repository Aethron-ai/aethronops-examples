# Compliance Matrix — appservice-web

> AethronOps compliance report for pattern **appservice-web** (mini, tier basic).
...
|-----------|-----------------|-----------|
| **CAF** (Cloud Adoption Framework) | APP-1, GOV-1, GOV-3, ID-1, ID-2, OPS-1, OPS-2, RG-1, RG-2, SEC-3, SEC-4 | [Microsoft CAF](https://learn.microsoft.com/azure/cloud-adoption-framework/) |
| **MCSB** (Microsoft Cloud Security Benchmark) | DP-1, DP-2, DP-3, DP-6, DP-7, DS-6, IM-1, IM-2, IR-1, IR-3, LT-1, LT-2, LT-3, LT-4, LT-5, NS-1 | [MCSB v1](https://learn.microsoft.com/security/benchmark/azure/overview) |
| **RGPD** (EU GDPR) | ART-25, ART-30, ART-32, ART-33 | [GDPR Text](https://gdpr-info.eu/) |
| **NIS2** (EU Directive 2022/2555) | ART-21-2a, ART-21-2b, ART-21-2f, ART-21-2h, ART-21-2i, ART-23 | [NIS2 Directive](https://eur-lex.europa.eu/eli/dir/2022/2555) |
...
| app-service | CAF: APP-1, SEC-3 | MCSB: NS-1, IM-1, DP-3, DS-6 | RGPD: ART-32, ART-25 | NIS2: ART-21-2b, ART-21-2h |
